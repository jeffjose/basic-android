...
class CupcakeScreenNavigationTest {
    ...
    @Test
    fun cupcakeNavHost_verifyBackNavigationNotShownOnFirstScreen() {
    ...
    @Test
    fun cupcakeNavHost_clickBackOnFlavorScreen_navigatesToFirstScreen() {
        navigateToFlavorScreen()
        performNavigateUp()
        navController.assertCurrentRouteName(CupcakeScreen.Start.name)
    }
    ...
    @Test
    fun cupcakeNavHost_clickCancelOnFlavorScreen_navigatesToFirstScreen() {
        navigateToFlavorScreen()
    ...
    @Test
    fun cupcakeNavHost_clickCancelOnPickupScreen_navigatesToFirstScreen() {
        navigateToPickupScreen()
        composeTestRule.onNodeWithStringId(R.string.cancel).performClick()
        navController.assertCurrentRouteName(CupcakeScreen.Start.name)
    }
    ...
    @Test
    fun cupcakeNavHost_clickCancelOnSummaryScreen_navigatesToFirstScreen() {
